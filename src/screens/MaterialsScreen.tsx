...
const styles = StyleSheet.create({
    ...
    statsBar: { flexDirection: 'row', gap: 10, paddingHorizontal: 16, paddingBottom: 16, flexWrap: 'wrap' },
    statChip: { flex: 1, minWidth: 90, borderRadius: 10, borderWidth: 1, padding: 8, alignItems: 'center' },
