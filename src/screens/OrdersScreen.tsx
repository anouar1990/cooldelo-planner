...
const styles = StyleSheet.create({
    ...
    header: { padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 },
    headerIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: C.primary + '15', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
    titleRow: { flexDirection: 'row', alignItems: 'center' },
    title: { fontSize: 20, fontWeight: '800', color: C.text },
    subtitle: { fontSize: 12, color: C.sub, marginTop: 4, marginLeft: 46 },
    addBtn: { backgroundColor: C.primary, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, height: 38, borderRadius: 10 },
    addBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    statsBar: { flexDirection: 'row', gap: 8, paddingHorizontal: 16, paddingBottom: 12, flexWrap: 'wrap' },
    ...
    filterPillText: { fontSize: 12, fontWeight: '600', color: C.sub },
    revenueBar: { flexDirection: 'row', gap: 10, paddingHorizontal: 16, paddingBottom: 12, flexWrap: 'wrap' },
    revChip: { flex: 1, minWidth: 120, borderRadius: 10, borderWidth: 1, padding: 10, alignItems: 'center' },
    revValue: { fontSize: 18, fontWeight: '800' },
    revLabel: { fontSize: 11, color: C.sub, marginTop: 2, fontWeight: '600' },
    searchBar: { flexDirection: 'row', alignItems: 'center', gap: 8, marginHorizontal: 16, marginBottom: 16, backgroundColor: C.surface, borderRadius: 10, borderWidth: 1, borderColor: C.border, paddingHorizontal: 12, height: 40 },
    searchInput: { flex: 1, color: C.text, fontSize: 13, ...(Platform.OS === 'web' ? { outlineStyle: 'none' } as any : {}) },
